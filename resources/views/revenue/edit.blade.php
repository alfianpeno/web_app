    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            @if (isset($revenue->add_receipt))
                <img id="image" class="mt-2 border border-primary" src="{{asset(Storage::url('uploads/revenue/'.$revenue->add_receipt))}}" wigth="120px" height="120px"/>
            @else
                <img id="image" class="mt-2 border border-primary" src="{{asset(Storage::url('uploads/defualt/defualt.png'))}}" wigth="120px" height="120px"/>
            @endif
        </div>
